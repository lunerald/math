...
\hypersetup{
	...
	urlcolor=blue}
\begin{document}
	{\bf Roots}-- only square roots -- please do not use a calculator.
	\begin{enumerate}[1.]
		
		%Exercise 2
		
		
		{\bf \item Take the root if possible} We have $\mathbb{G}=\mathbb{R}^+$
		...
		{\bf \item Move under the root and summarize} We have $\mathbb{G}=\mathbb{R}^+$
		...
		{\bf \item Remove partial roots} We have $\mathbb {G}=\mathbb {R}^+$
		...
		{\bf \item Simplify as much as possible.} Irrational numbers remain.
	...
	\fbox{
		\begin{minipage}{0.5\textwidth}
			For the solution, please \href{https://www.okuyakl.de/math/m9wurL044/le044.pdf}{click here} or scan the QR code.\\
		...
		\begin{minipage}{0.4\textwidth}
			...
			\includegraphics[width=3 cm]{qre044}
