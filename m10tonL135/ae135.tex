...
\begin{tabular}{|>{\columncolor[gray]{.8}}p{3 cm}|p{3 cm}|p{3 cm}|p{3 cm}|p{3 cm}|}
	\hline
	\rowcolor[gray]{.8} Name & Semitone Steps & Notes & $2^{x/12}$ & Frequency Ratio \\
...
\begin{tabular}{|>{\columncolor[gray]{.8}}p{3 cm}|p{3 cm}|p{3 cm}|p{3 cm}|p{3 cm}|} 
	...
	\vspace{1 cm}
	{\bf \item How many percent does the frequency increase by  \underbar{one} semitone step?}
	\vspace{1 cm}
	{\bf \item Play the intervals with a piano-app}.
