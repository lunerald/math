...
\begin{tabular}{|>{\columncolor[gray]{.8}}p{3 cm}|p{2.5 cm}|p{3 cm}|p{2.5 cm}|p{4 cm}|}
	\hline
	\rowcolor[gray]{.8}	Name & Halbtonschritte &  Noten & $2^{x/12}$ & $\approx$   Frequenzverhältnis *  \\
	\hline
     Prime & & 	 
	  \begin{music}
	  	\instrumentnumber{1}
...
\vspace{1 cm}
* Es gibt Unterschiede zwischen der gleichförmigen und der natürlichen Stimmung. 
Die Näherungswerte für die Frequenzverhältnisse sind:
\quad\fbox{1 : 1}
\quad\fbox{5:4}
\quad\fbox{4:3}
\quad\fbox{6:5}
...
\vspace{1 cm}
{\bf \item Was hat ein Halbtonschritt mit $\sqrt[12]{2}$ zu tun?}
\vspace{1 cm}
{\bf \item Spiele die Intervalle auf einer Piano-App. Welches ist Dein Lieblingsintervall?}.
