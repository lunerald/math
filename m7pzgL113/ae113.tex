...
\begin{document}
	...
	\begin{enumerate}[1.]
		{\bf \item If possible, simplify the following powers with the first power law $a^m \cdot a^n = a^{m+n}$}
		...
		{\bf \item Simplify the following powers with the second power law ${a^m \over a^n} = a^{m-n}$}
		...
		{\bf \item Convert negative powers to fractions and vice versa}
		...
		{\bf \item Simplify the following powers with the third power law $(a^m)^n = a^{m\cdot n}$}
		...
		\newpage
		{\bf \item Summarize according to the rules $a^nb^n = (ab)^n \qquad {a^n\over b^n} = ({a\over b})^n$}
		...
		{\bf \item Write as a power with the simplest possible base}
		...
		{\bf \item Summarize if possible. Decide which laws you will apply}
	...
	\fbox{
		\begin{minipage}{0.5\textwidth}
			For the solution, please \href{https://www.okuyakl.de/math/m7pzgL113/le113.pdf}{click here} or scan the QR code.\\
		...
		\begin{minipage}{0.4\textwidth}
			...
			\includegraphics[width=3 cm]{qre113}
